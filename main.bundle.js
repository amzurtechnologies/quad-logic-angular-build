...
var MeterPageComponent = (function () {
    function MeterPageComponent(meterPageService, _fb, sectionService, confirmationService, route) {
        ...
        this.meterForm = this._fb.group({
            ...
            multiplier: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](1.0, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required),
            modifier: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](1.0, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required),
            is_active: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](true, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required)
        });
    }
    MeterPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.meterPageService.getMeters(_this.site_id)
                ...
                // this.meters = this.datasource.slice(0, 10);
            });
    ...
    MeterPageComponent.prototype.showDialog = function () {
        ...
        this.meterForm.controls["multiplier"].setValue(1.0);
        this.meterForm.controls["modifier"].setValue(1.0);
        this.meterForm.controls["is_active"].setValue(true);
        this.formType = "Create";
    };
    ...
    MeterPageComponent.prototype.loadMeterLazy = function (event) {
        ...
        setTimeout(function () {
            if (_this.datasource) {
                _this.meters = _this.datasource.slice(event.first, (event.first + event.rows));
            }
        }, 250);
    };
...
var OverviewComponent = (function () {
    ...
    OverviewComponent.prototype.createUser = function (userCreateForm) {
        ...
        if (userCreateForm.valid) {
            ...
            this.setFormTouched(this.userCreateForm);
        }
    };
    // function for validate all form fields
    OverviewComponent.prototype.setFormTouched = function (form_obj) {
        // this._toastr.error("please fill all * marked fields", 'Oops!', { showCloseButton: true });
        Object.keys(form_obj.controls).forEach(function (field) {
            var control = form_obj.get(field);
            control.markAsTouched({ onlySelf: true });
...
var SectionsComponent = (function () {
    function SectionsComponent(sectionService, _fb, route, confirmationService) {
        ...
        this.sectionForm = this._fb.group({
            id: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](),
            section_name: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required),
            utility_type_id: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required),
    ...
    SectionsComponent.prototype.editDialog = function (sectionId) {
        var _this = this;
        this.sectionId = sectionId;
        this.sectionService.getSectionDetails(sectionId).subscribe(function (res) {
            _this.display = true;
            _this.sectionForm.setValue(res.section);
            _this.formType = "Edit";
        });
    };
    // function for validate all form fields
    ...
    SectionsComponent.prototype.testAction = function (rowData) {
        var _this = this;
        this.beforeEditSection = rowData;
        this.actions = [
            { label: 'Edit', icon: 'far fa-pencil', command: function () {
                    _this.editDialog(rowData.id);
                } },
    ...
    SectionsComponent.prototype.deleteDialog = function (sectionId) {
        var _this = this;
        this.sectionId = sectionId;
        this.msgs = [];
        this.confirmationService.confirm({
            ...
            icon: 'fa fa-question-circle',
            accept: function () {
                var sections = _this.sections.slice();
                _this.sectionService.deleteSection(sectionId).subscribe(function (res) {
                    if (res.success) {
...
var SectionsService = (function () {
    ...
    SectionsService.prototype.getSectionDetails = function (id) {
        return this.httpClient.get(__WEBPACK_IMPORTED_MODULE_2_environments_environment__["a" /* environment */].host + "get_section_details/" + id);
    };
...
var TenantsService = (function () {
    ...
    TenantsService.prototype.getTenants = function (site_id) {
        return this.httpClient.get(__WEBPACK_IMPORTED_MODULE_2_environments_environment__["a" /* environment */].host + "tenants", { params: { site_id: site_id } });
    };
...
var UnitsService = (function () {
    ...
    UnitsService.prototype.checKMeters = function (reqBody) {
        return this.httpClient.post(__WEBPACK_IMPORTED_MODULE_2_environments_environment__["a" /* environment */].host + "check_meters", reqBody);
    };
...
var SiteComponent = (function () {
    ...
    SiteComponent.prototype.onTabChange = function (event) {
        var tabValue = this.breadCrumbValues[event.index];
        this.getTabValue(tabValue);
        if (tabValue == "Sections") {
            this.isSections = true;
        }
        else if (tabValue == "Units") {
            this.isUnits = true;
        }
        else if (tabValue == "Meters") {
            this.isMeters = true;
        }
        else if (tabValue == "Tenants") {
            this.isTenants = true;
        }
        console.log(this.isSections);
    };
...
var SitesListComponent = (function () {
    function SitesListComponent(siteService, _fb, confirmationService) {
        ...
        this.siteCreateForm = this._fb.group({
            ...
            short_zipcode: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]()
        });
    }
    SitesListComponent.prototype.ngOnInit = function () {
        ...
        this.siteService.getSites()
            ...
            _this.datasource = data.sites;
            _this.totalRecords = _this.datasource.length;
            _this.sites = _this.datasource.slice(0, 10);
            ;
        });
        this.loading = true;
    };
    SitesListComponent.prototype.createSite = function (siteCreateForm) {
        ...
        if (siteCreateForm.valid) {
            if (siteCreateForm.value.id == null) {
    ...
    SitesListComponent.prototype.editSiteDialog = function (siteId) {
        var _this = this;
        this.siteService.getSiteDetails(siteId).subscribe(function (res) {
            _this.siteCreateForm.setValue(res.site);
            _this.display = true;
            _this.formType = "Edit";
        });
    };
    ...
    SitesListComponent.prototype.loadCarsLazy = function (event) {
        var _this = this;
        this.loading = true;
        setTimeout(function () {
            if (_this.datasource) {
                _this.sites = _this.datasource.slice(event.first, (event.first + event.rows));
                _this.loading = false;
            }
        }, 250);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__sites_list_sites_list_component__ = __webpack_require__("./src/app/sites/sites-list/sites-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_sites_service_service__ = __webpack_require__("./src/app/sites/services/sites-service.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_units_service__ = __webpack_require__("./src/app/sites/services/units.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_sections_service__ = __webpack_require__("./src/app/sites/services/sections.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_tenants_service__ = __webpack_require__("./src/app/sites/services/tenants.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_meter_page_service__ = __webpack_require__("./src/app/sites/services/meter-page.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__site_site_component__ = __webpack_require__("./src/app/sites/site/site.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__sections_sections_component__ = __webpack_require__("./src/app/sites/sections/sections.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__overview_overview_component__ = __webpack_require__("./src/app/sites/overview/overview.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__meter_page_meter_page_component__ = __webpack_require__("./src/app/sites/meter-page/meter-page.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__units_units_component__ = __webpack_require__("./src/app/sites/units/units.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__tenants_tenants_component__ = __webpack_require__("./src/app/sites/tenants/tenants.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__services_user_service__ = __webpack_require__("./src/app/sites/services/user.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28_primeng_button__ = __webpack_require__("./node_modules/primeng/button.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28_primeng_button___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_28_primeng_button__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29_primeng_growl__ = __webpack_require__("./node_modules/primeng/growl.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29_primeng_growl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_29_primeng_growl__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30_primeng_confirmdialog__ = __webpack_require__("./node_modules/primeng/confirmdialog.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30_primeng_confirmdialog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_30_primeng_confirmdialog__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__keys_pipe__ = __webpack_require__("./src/app/keys.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33_app_upload_upload_component__ = __webpack_require__("./src/app/upload/upload.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    SitesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_28_primeng_button__["ButtonModule"],
                __WEBPACK_IMPORTED_MODULE_30_primeng_confirmdialog__["ConfirmDialogModule"],
                __WEBPACK_IMPORTED_MODULE_29_primeng_growl__["GrowlModule"],
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_14__sites_list_sites_list_component__["a" /* SitesListComponent */], __WEBPACK_IMPORTED_MODULE_20__site_site_component__["a" /* SiteComponent */], __WEBPACK_IMPORTED_MODULE_21__sections_sections_component__["a" /* SectionsComponent */], __WEBPACK_IMPORTED_MODULE_22__overview_overview_component__["a" /* OverviewComponent */], __WEBPACK_IMPORTED_MODULE_23__meter_page_meter_page_component__["a" /* MeterPageComponent */], __WEBPACK_IMPORTED_MODULE_24__units_units_component__["a" /* UnitsComponent */], __WEBPACK_IMPORTED_MODULE_25__tenants_tenants_component__["a" /* TenantsComponent */], __WEBPACK_IMPORTED_MODULE_32__keys_pipe__["a" /* KeysPipe */], __WEBPACK_IMPORTED_MODULE_33_app_upload_upload_component__["a" /* UploadComponent */]],
            providers: [__WEBPACK_IMPORTED_MODULE_15__services_sites_service_service__["a" /* SitesServiceService */], __WEBPACK_IMPORTED_MODULE_16__services_units_service__["a" /* UnitsService */], __WEBPACK_IMPORTED_MODULE_19__services_meter_page_service__["a" /* MeterPageService */], __WEBPACK_IMPORTED_MODULE_17__services_sections_service__["a" /* SectionsService */], __WEBPACK_IMPORTED_MODULE_18__services_tenants_service__["a" /* TenantsService */], __WEBPACK_IMPORTED_MODULE_31_primeng_api__["ConfirmationService"], __WEBPACK_IMPORTED_MODULE_27__services_user_service__["a" /* UserService */]]
        })
    ], SitesModule);
    return SitesModule;
}());
...
module.exports = ".tanants-detils-show h4{\n    font-weight: 400;\n    font-size: 14px;\n    margin: 5px 0;\n}\n.tanants-detils-show h4 span{\n    display: inline-block;\n    width: 180px;\n    font-size: 16px;\n    font-weight: 600;\n}"
...
var TenantsComponent = (function () {
    function TenantsComponent(tenantService, _fb, confirmationService, route) {
        ...
        this.tenantCreateForm = this._fb.group({
            ...
            unit_ids: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormControl"](null, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required),
            ...
            floor_plan_id: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormControl"](),
    ...
    TenantsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.tenantService.getTenants(_this.site_id)
                ...
                // this.totalRecords = this.datasource.length;
                // this.tenants = this.datasource.slice(0, 10);
    ...
    TenantsComponent.prototype.editTenantDialog = function (tenant) {
        ...
        if (tenant["status"] != null) {
            if (tenant["status"]) {
                tenant["status"] = { label: "Active", value: true };
            }
            else {
                tenant["status"] = { label: "Inactive", value: false };
            }
        }
        this.tenant_copy["status"] = tenant["status"];
        // two fields not required for tenants edit
        delete this.tenant_copy.id;
        delete this.tenant_copy.name;
        delete this.tenant_copy.units;
    ...
    TenantsComponent.prototype.loadMeterLazy = function (event) {
        var _this = this;
        setTimeout(function () {
            if (_this.datasource) {
                _this.tenants = _this.datasource.slice(event.first, (event.first + event.rows));
            }
        }, 250);
    };
    TenantsComponent.prototype.showTenantDetails = function (tenant) {
        console.log(tenant);
        this.showTenant = true;
        this.showingTenant = tenant;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
...
module.exports = "<div class=\"ui-widget-header ql-search\" style=\"padding:4px 10px;border-bottom: 0 none\">\n    <i class=\"fa fa-search\" style=\"margin:4px 4px 0 0\"></i>\n    <input #gb type=\"text\" pInputText size=\"50\" placeholder=\"Search...\">\n    <!-- <button pButton type=\"button\" label=\"Click\" ></button> -->{{uploadUrl}}\n    <div style=\"float:right;\">\n        <button type=\"button\" (click)=\"showDialog()\" pButton label=\"Add Section\" styleClass=\"col-button\">Move</button>\n        <quadlogic-upload params=\"name=units&site={{site_id}}\"></quadlogic-upload>\n        <button type=\"button\" (click)=\"showDialog()\" pButton label=\"Add Section\">Create Unit</button>\n    </div>\n</div>\n\n<p-dataTable class=\"overview-select\" [lazy]=\"false\" [value]=\"units\" scrollable=\"true\" reorderableColumns=\"true\" [rows]=\"10\" [rowsPerPageOptions]=\"[5,10,20]\" [paginator]=\"true\" [pageLinks]=\"10\" [totalRecords]=\"totalRecords\" (onLazyLoad)=\"loadMeterLazy($event)\"\n    [globalFilter]=\"gb\" #dt>\n    <p-column field=\"identifier\" [sortable]=\"true\" header=\"Unit Id\"></p-column>\n    <p-column field=\"residents\" [sortable]=\"true\" header=\"Tenants\"></p-column>\n    <p-column field=\"section_labels\" [sortable]=\"true\" header=\"Sections\"></p-column>\n    <p-column field=\"meters\" [sortable]=\"true\" header=\"Meter id\"></p-column>\n    <p-column styleClass=\"col-button\">\n        <ng-template pTemplate=\"header\">\n            Actions\n        </ng-template>\n        <ng-template let-section=\"rowData\" pTemplate=\"body\">\n            <p-splitButton class=\"site-edit float-right\" icon=\"far fa-ellipsis-v\" (click)=\"testAction(section)\" [model]=\"actions\"></p-splitButton>\n        </ng-template>\n    </p-column>\n</p-dataTable>\n\n<p-dialog header=\"{{formType}} Unit\" [(visible)]=\"display\" modal=\"modal\" [responsive]=\"true\" [width]=\"600\" [minWidth]=\"200\" [minY]=\"200\">\n    <form [formGroup]=\"unitForm\" (ngSubmit)=\"createUnit(unitForm)\">\n        <div class=\"ui-g ui-fluid\">\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\">Section*</h3>\n                <p-multiSelect [options]=\"sections\" formControlName=\"sections\" placeholder=\"Select sections\"  required></p-multiSelect>\n                <span *ngIf=\" !unitForm.get('sections').valid && unitForm.get('sections').touched && unitForm.hasError('required', 'sections')\" class=\"error-message\">\n                    section(s) is/are required</span>\n            </span>\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\"> Apartment Number (max 10 chars) *</h3>\n                <input class=\"login-input\" name=\"apartment_number\" pattern=\".{0}|.{1,10}\" maxlength=\"10\" id=\"apartment_number\" type=\"text\" size=\"30\" pInputText placeholder=\"Enter apartment number\"\n                    formControlName=\"apartment_number\" required=\"required\">\n                <span *ngIf=\" !unitForm.get('apartment_number').valid && unitForm.get('apartment_number').touched && unitForm.hasError('required', 'apartment_number')\" class=\"error-message\">\n                    apartment number is required</span>\n            </span>\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\">Apartment Area *</h3>\n                <input class=\"login-input\" min=\"1\" max=\"100000\" name=\"apartment_area\" id=\"apartment_area\" type=\"number\" size=\"30\" pInputText placeholder=\"Enter apartment area\"\n                    formControlName=\"apartment_area\" required=\"required\">\n                <span *ngIf=\" !unitForm.get('apartment_area').valid && unitForm.get('apartment_area').touched && unitForm.hasError('required', 'apartment_area')\" class=\"error-message\">\n                    apartment area is required</span>\n            <span *ngIf=\" !unitForm.get('apartment_area').valid && unitForm.get('apartment_area').touched && unitForm.hasError('max', 'apartment_area')\" class=\"error-message\">\n                    apartment area should not be more than 100000</span>\n            <span *ngIf=\" !unitForm.get('apartment_area').valid && unitForm.get('apartment_area').touched && unitForm.hasError('min', 'apartment_area')\" class=\"error-message\">\n                    apartment area should  be more than 0</span>\n            </span>\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\">Number of rooms *</h3>\n                <input  class=\"login-input\" type=\"number\" min=\"1\" max=\"1000\" pInputText placeholder=\"enter number of rooms \" formControlName=\"no_of_rooms\" required>\n                <span *ngIf=\" !unitForm.get('no_of_rooms').valid && unitForm.get('no_of_rooms').touched && unitForm.hasError('required', 'no_of_rooms')\" class=\"error-message\">\n                    number of rooms is required</span>\n            <span *ngIf=\" !unitForm.get('no_of_rooms').valid && unitForm.get('no_of_rooms').touched && unitForm.hasError('max', 'no_of_rooms')\" class=\"error-message\">\n                    number of rooms should not be more than 1000</span>\n            <span *ngIf=\" !unitForm.get('no_of_rooms').valid && unitForm.get('no_of_rooms').touched && unitForm.hasError('min', 'no_of_rooms')\" class=\"error-message\">\n                        number of rooms should  be more than 0</span>\n            </span>\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\">Unit sort number *</h3>\n                <input  class=\"login-input\" type=\"number\" min=\"1\" max=\"1000000000\" pInputText placeholder=\"enter unit sort number \" formControlName=\"unit_sort_number\" required>\n                <span *ngIf=\" !unitForm.get('unit_sort_number').valid && unitForm.get('unit_sort_number').touched && unitForm.hasError('required', 'unit_sort_number')\" class=\"error-message\">\n                    unit sort number is required</span>\n            <span *ngIf=\" !unitForm.get('unit_sort_number').valid && unitForm.get('unit_sort_number').touched && unitForm.hasError('max', 'unit_sort_number')\" class=\"error-message\">\n                    unit sort number should not be more than 1000000000</span>\n            <span *ngIf=\" !unitForm.get('unit_sort_number').valid && unitForm.get('unit_sort_number').touched && unitForm.hasError('min', 'unit_sort_number')\" class=\"error-message\">\n                        unit sort number should be more than 0</span>\n            </span>\n\n            <span class=\"form-group ui-g-6\">\n                <h3 class=\"login-label\">Meters * (please enter by comma seperated)</h3>\n                <input class=\"login-input\" name=\"meters\" id=\"meters\" type=\"text\" size=\"30\" pInputText placeholder=\"Enter meters by comma sperated\"\n                    formControlName=\"meters\" (blur)=\"checkMeters()\" required=\"required\">\n                <span *ngIf=\" !unitForm.get('meters').valid && unitForm.get('meters').touched && unitForm.hasError('required', 'meters')\" class=\"error-message\">\n                    meter(s) is/are required</span>\n            <span *ngIf=\" !unitForm.get('meters').valid && unitForm.get('meters').touched && unitForm.hasError('incorrect', 'meters')\" class=\"error-message\">\n                    {{unitErrors}}    \n                </span>\n            </span>\n        </div>\n\n        <p-footer>\n            <!-- <button type=\"submit\" pButton label=\"Yes\">Submit</button> -->\n            <!-- <button type=\"cancel\" pButton (click)=\"display=false\" label=\"No\">Cancel</button> -->\n            <button type=\"submit\" pButton class=\"ui-button btn-orange\" label=\"Save changes\" *ngIf=\"unitId == 0\">Create</button>\n            <button type=\"submit\" pButton class=\"ui-button btn-orange\" label=\"Save changes\" *ngIf=\"unitId != 0\">Update</button>\n            <button type=\"button\" pButton class=\"ui-button-secondary\" (click)=\"display=false\" label=\"close\">Close</button>\n        </p-footer>\n    </form>\n</p-dialog>\n"
...
var UnitsComponent = (function () {
    function UnitsComponent(unitService, route, _fb, confirmationService) {
        ...
        this.unitForm = this._fb.group({
            id: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](),
            meters: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](null, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required),
            ...
            apartment_area: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](null, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].max(100000), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].min(1)]),
            no_of_rooms: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](null, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].max(1000), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].min(1)]),
            unit_sort_number: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](null, [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].max(1000000000), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].min(1)]),
            sections: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormControl"](null, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required)
        });
    }
    UnitsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.unitService.getUnits(_this.site_id)
                ...
                // this.totalRecords = this.datasource.length;
                // this.units = this.datasource.slice(0, 10);
            });
    ...
    UnitsComponent.prototype.deleteDialog = function (unitId) {
        ...
        this.confirmationService.confirm({
            message: 'Are you sure that you want to proceed?',
            header: 'Delete this unit',
            icon: 'fa fa-question-circle',
            accept: function () {
                _this.unitService.deleteUnit(unitId).subscribe(function (res) {
    ...
    UnitsComponent.prototype.loadMeterLazy = function (event) {
        var _this = this;
        setTimeout(function () {
            if (_this.datasource) {
                _this.units = _this.datasource.slice(event.first, (event.first + event.rows));
            }
        }, 250);
    };
    ...
    UnitsComponent.prototype.checkMeters = function () {
        var _this = this;
        this.unitErrors = '';
        if (this.unitForm.value.meters) {
            this.unitService.checKMeters({ meters: this.unitForm.value.meters, site: this.site_id }).subscribe(function (res) {
                if (res.invalid_meters.length > 0) {
                    _this.unitForm.controls['meters'].setErrors({ 'incorrect': true });
                    if (res.invalid_meters.length == 1) {
                        _this.unitErrors = res.invalid_meters[0] + " invalid meter";
                    }
                    else {
                        _this.unitErrors = res.invalid_meters.join(" ,") + " invalid meters";
                    }
                }
                else {
                    // this.unitForm.controls['meters'].setErrors({'incorrect':false});
                }
            });
        }
    };
...
module.exports = "<p-growl [(value)]=\"msgs\"></p-growl>\n<p-fileUpload mode=\"basic\" class=\"upload-file\" name=\"file\" url=\"{{url}}\" (onUpload)=\"onUploadSuccess($event)\" (onProgress)=\"onUploadProgress($event)\" (onError)=\"onUploadError($event)\" ></p-fileUpload>\n"
...
var UploadComponent = (function () {
    ...
    UploadComponent.prototype.ngOnInit = function () {
        this.url = __WEBPACK_IMPORTED_MODULE_1_environments_environment__["a" /* environment */].host + "upload_records?" + this.params;
    };
    UploadComponent.prototype.onUploadProgress = function (event) {
        console.log(event);
        this.msgs = [];
        this.msgs.push({ severity: 'info', summary: 'Progress', detail: "file uploading is in progress" });
    };
    UploadComponent.prototype.onUploadSuccess = function (event) {
        console.log(event);
        this.msgs = [];
        this.msgs.push({ severity: 'success', summary: 'Success', detail: "file uploaded" });
    };
    UploadComponent.prototype.onUploadError = function (event) {
        console.log(event);
        this.msgs = [];
        this.msgs.push({ severity: 'error', summary: 'Error', detail: "error occuring " });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], UploadComponent.prototype, "params", void 0);
    UploadComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'quadlogic-upload',
