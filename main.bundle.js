    ...
    MeterPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.meterPageService.getMeters(_this.site_id)
                ...
                _this.datasource = data.meters;
                _this.totalRecords = _this.datasource.length;
                _this.meters = _this.datasource.slice(0, 10);
            });
...
var OverviewComponent = (function () {
    ...
    OverviewComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.userService.getUsersAndRoles(_this.site_id)
                ...
                _this.users = _this.datasource.slice(0, 10);
            });
        });
    };
    ...
    OverviewComponent.prototype.loadMeterLazy = function (event) {
        var _this = this;
        setTimeout(function () {
            if (_this.datasource) {
    ...
    TenantsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.tenantService.getTenants(_this.site_id)
                ...
                _this.datasource = data.tenants;
                _this.totalRecords = _this.datasource.length;
                _this.tenants = _this.datasource.slice(0, 10);
    ...
    UnitsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.unitService.getUnits(_this.site_id)
                ...
                _this.datasource = data.units;
                _this.totalRecords = _this.datasource.length;
                _this.units = _this.datasource.slice(0, 10);
            });
